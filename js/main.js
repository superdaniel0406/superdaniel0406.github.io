(function($) {
    ...
    // /Hide Mobile menu
    function fillSkillsBars() {
        $(".skill-percentage").each(function(index) {
            if (typeof $(this).data("amount") != "undefined")
                $(this).css("width", $(this).data("amount") + "%");
        });
    }
    ...
    $(document).on('ready', function() {
        $("#changeLang").click(function(event){
            ...
            console.log($("#changeLang").data("href"))
            $.get($("#changeLang").data("href"), function(data, status){
                location.reload();
            });
        })
