;window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="103f6bde8369d424d1e70280e449892b";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){'use strict'
...
return false}}());CloudflareApps.installs["VPxsxPZHUs55"]={appId:"lMxPPXVOqmoE",scope:{}};;CloudflareApps.installs["VPxsxPZHUs55"].options={"account":{"accountId":"SqDUo63Zoubf","service":"googleanalytics","userId":"104236819554499786344"},"anonymizeIp":false,"id":"","organization":"135051891","social":false,"web-properties-for-135051891":"UA-135051891-2","webPropertySchemaNames":["web-properties-for-135051891"]};;if(CloudflareApps.matchPage(CloudflareApps.installs['VPxsxPZHUs55'].URLPatterns)){(function(){var options=CloudflareApps.installs['VPxsxPZHUs55'].options;var id;if(options.account&&options.organization){id=options["web-properties-for-"+options.organization];}else{id=(options.id||"").trim();}
if(!id){console.log("Cloudflare Google Analytics: Disabled. UA-ID not present.");return;}else if("VPxsxPZHUs55"==="preview"){console.log("Cloudflare Google Analytics: Enabled",id);}
